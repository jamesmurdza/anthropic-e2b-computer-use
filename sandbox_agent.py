from os_computer_use.grounding import draw_big_dot, extract_bbox_midpoint, extract_norm_point
...
class SandboxAgent:
    ...
    def click_element(self, query, click_command, action_name="click", grounder='showui'):
        ...
        elif grounder == 'osatlas':
            pred, image_url = grounding_model.call(
